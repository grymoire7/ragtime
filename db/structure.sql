...
CREATE UNIQUE INDEX "index_models_on_provider_and_model_id" ON "models" ("provider", "model_id");
CREATE INDEX "index_models_on_provider" ON "models" ("provider");
CREATE INDEX "index_models_on_family" ON "models" ("family");
...
CREATE INDEX "index_chats_on_model_id" ON "chats" ("model_id");
...
CREATE INDEX "index_messages_on_role" ON "messages" ("role");
